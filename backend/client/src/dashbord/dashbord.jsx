...
export default function Dashboard() {
  ...
  const stats = [
    { title: "Total Students", count: totalStudents, icon: "👨‍🎓" },
    { title: "Active Courses", count: courses.length, icon: "📚" },
    { title: "Average Grade", count: "78%",  icon: "📊" },
    { title: "Attendance Rate", count: "92%",  icon: "📅" },
  ];
